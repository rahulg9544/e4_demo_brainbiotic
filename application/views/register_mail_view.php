...
<center> 
 ...
 <table width="100%" align="center" cellpadding="0" cellspacing="0" border="0" bgcolor="#ededed" style="table-layout:fixed;margin:0 auto;mso-table-lspace:0pt;mso-table-rspace:0pt; margin-bottom:0px; padding-top: 0px; border-top:4px solid #cc1253; ">
    ...
    margin:0 !important;
    padding-left: 1%;">
Call +965 506 25 825 Extended hours M-F 6am-8pm</p>
								...
								<tbody><tr>
									...
									<td>
										<table width="730" cellpadding="0" cellspacing="0" bgcolor="#e0dede" border="0" class="centerize" style="mso-table-lspace:0pt;mso-table-rspace:0pt;">
											<tbody><tr>
												<td valign="middle" align="left" height="60" style="line-height:1px;padding-left:15px; "><a href="#" target="_blank"><img src="<?php echo base_url(); ?>img/logo/9cadb11c-caae-447f-a325-c2d8edfe845d.jfif" style="display:block;" alt="Logo Image" border="0" align="top" hspace="0" vspace="0" width="252" height="60"></a></td>
...
<h2 class="titile-main">GREETING FROM Brain biotic</h2>
<p>Thank you for your Interest</p> 
<p style="font-weight: 600"><strorng>Welcome <?php echo $test['fname']; ?></strorng></p>    
</td>
</tr>
                                                
                 <tr>
                                                
                                                <td><p style="font-family:Geneva,Arial;font-weight: 600; text-align: center; margin-bottom: 10px;">Thank you for your registration with Brain biotic</p> </td>
...
<tbody>
<tr>
    <td style="border: 1px solid #dddddd;text-align: center;padding: 12px;" class="total"><strong>Your user name</strong></td>
<td class="unit" style="border: 1px solid #dddddd;text-align: center;padding: 12px;">
    <?php echo $test['tomail']; ?>
</td>

   
</tr>
    <tr>
  <td class="total" style="border: 1px solid #dddddd;text-align: center;padding: 12px;"><strong>Verification Code</strong></td>
<td class="unit" style="border: 1px solid #dddddd;text-align: center;padding: 12px;"><?php echo $test['verification_code']; ?></td>   
 </tr>  
...
<td height="20" class="RegularTextTD" style="font-size: 18px; text-align: center; padding-bottom: 10px;">For any questions, please call M-F 6am - 8pm ET</td>
     ...
     <tr>
<!--SHIPPING ADDRESS AND Payment Method Information-->
<td height="20" class="RegularTextTD" style="font-size: 18px; text-align: center; padding-bottom: 10px;">+965 506 25 825 . support@brainbiotic.com</td>
</tr> 
					...
					<tbody><tr>
						<td> 
                                          <table width="510" align="center" cellpadding="0" cellspacing="0" border="0" bgcolor="#ededed" class="table600">         	
                                                ...
                                                <tr style="text-align: center;"><td align="center" style="font-family: sans-serif; padding: 10px 0px;"><a href="<?php echo base_url(); ?>index.php/Myaccount" style="font-size: 13px; color: #000; float: left;" target="_blank">My Account <span style="margin-left: 5px; margin-right: 10px;">|</span> </a> 
    <a href="<?php echo base_url(); ?>index.php/Orderhistory" style="font-size: 13px; color: #000; float: left;" target="_blank">Order History <span  style="margin-left: 5px; margin-right: 10px;">|</span> </a>  
    ...
    <a href="<?php echo base_url(); ?>index.php/Home/newarrivalprods" style="font-size: 13px; color: #000; float: left;"> New Arrivals <span  style="margin-left: 5px; margin-right: 10px;">|</span></a> 
    <a href="<?php echo base_url(); ?>index.php/Topsellers" style="font-size: 13px; color: #000; float: left;" target="_blank">Top Sellers</a></td></tr>    
                                ...
                                This email was sent to <?php echo $test['fname'] ?>.<br>
                                You're receiving this email because you opted in at brainbiotic<br>
© 2020 brainbiotic, All rights reserved.                    
...
<table width="100%" style="background: #ccc; padding: 10px;">
    ...
    <td align="center" style="font-family: sans-serif; padding: 10px 0px;"><p>You received this email from brain biotic..<br>
