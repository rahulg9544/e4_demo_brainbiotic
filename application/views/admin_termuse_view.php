            ...
            <div class="col-md-4">
              <div class="media">
                <div class="media-body">
                  <div class="display-6">Delivery Policy</div>
...
<div class="modal fade-scale" id="trackermodal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
     ...
     <script type="text/javascript">
      ...
      function getpromocode(){
           $.ajax({
                method: "POST",
                url: "<?php echo base_url('index.php/Admin_termuse/get_aboutinf');?>/",
                data: '', 
      ...
      // }
        ...
        $('#modalcaption').text("Edit Terms of use");
        $.ajax({
              method: "POST",
              url: "<?php echo base_url('index.php/Admin_termuse/editaboutinfo');?>/",
            ...
            //   alert(data);
              ...
              $('#tuid').val(res.termuse_id);
              $('#tucontent').summernote('code',res.termuse_content);
              $('#tucontent_arab').summernote('code',res.termuse_content_arab);
      ...
      $("#idFormpromo").submit(function(e) {
         ...
         $.ajax({
                method: "POST",
                url: "<?php echo base_url('index.php/Admin_termuse/updatetcinfo');?>/",
