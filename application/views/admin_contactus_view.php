          ...
          <div class="modal-body">
           <form method="POST"  id="idFormpromo" enctype="multipart/form-data" accept-charset="utf-8">
                  <div class="row m-b-2">
                    ...
                    <div class="form-group col-sm-6">
                      <h4 class="demo-sub-title">Whatsapp</h4>
                    
                     <input class="form-control" type="text" name="contwhatsp" id="contwhatsp" required="required" >
                    </div>


                     <div class="form-group col-sm-6">
                      <h4 class="demo-sub-title">Phone Number</h4>
                      <input class="form-control" type="text" name="contphon" id="contphon" required="required" >
                     </div>
      ...
      function getpromocode(){
        ...
        $.ajax({
             ...
             success: function(data){
              ...
              $('#contwhatsp').val(res.contact_whatsapp);
