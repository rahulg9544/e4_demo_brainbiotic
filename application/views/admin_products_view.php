              ...
              <div class="panel-heading">
                ...
                <div class="panel-body">
                  ...
                  <div class="row m-b-2">
                    ...
                    <div class="form-group col-sm-6" >
                    <h4 class="demo-sub-title">Have Size and Color choice?</h4>
                      <select class="form-control" name="sizecolorchoice"  id="sizecolorchoice" onchange="checksizechoice($(this).val());" >
...
//check if exsists more than one box
 ...
 // footwear & shoe append box
                   ...
                   if(res.subcategory_name=='Footwear' || res.subcategory_name=='footwear' || res.subcategory_name=='Sheos' || res.subcategory_name=='sheos')
                    ...
                    var size_box = '<div class="form-group col-sm-4"><label class="demo-sub-title">Shoe Size</label><select class="form-control " name="shoesize_nm[]" id="shoesize_id'+s+'"><option value="'+sizeary[s]+'">'+sizeary[s]+'</option><option value="18">18</option><option value="20">20</option><option value="22">22</option><option value="24">24</option><option value="26">26</option><option value="28">28</option><option value="30">30</option><option value="32">32</option><option value="34">34</option><option value="36">36</option><option value="38">38</option><option value="40">40</option><option value="42">42</option><option value="44">44</option><option value="46">46</option></select></div>';

                           if(s==0)
                           {
                             appentstring+='<div id=block'+s+'>'+size_box+''+colorsectn+second_line_section+'<div class="form-group col-sm-1" style="padding-top: 2.8%;"><button class="btn btn-success" type="button" onclick="nextadd()" id="subs'+s+'" style="padding: 0px 13px;border-radius: 8px;font-size: 22px;">+</button></div></div><br>';
                           }
                           else
                           {
                             appentstring+='<div id=block'+s+'>'+size_box+''+colorsectn+second_line_section+'<div class="form-group col-sm-1" style="padding-top: 2.8%;"><button class="btn btn-danger" type="button" onclick="removeblock('+s+')" id="subs'+s+'" style="padding: 0px 13px;border-radius: 8px;font-size: 22px;">-</button></div></div><br>';
                           }
...
//product edit
   ...
   $(function () {
    ...
    //   }
     ...
     function checksizechoice(sizecolorchoice)
      {
