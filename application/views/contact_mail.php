...
.headr{ background: #cc1253; width:700px;  height: 50px;  font-family:Geneva,Arial; padding: 0 15px;}
...
<table width="100%" align="center" cellpadding="0" cellspacing="0" border="0" bgcolor="#ededed" style="table-layout:fixed;margin:0 auto;mso-table-lspace:0pt;mso-table-rspace:0pt; margin-bottom:0px; padding-top: 0px; border-top:4px solid #cc1253; ">
...
<div class="headr" style="text-align:left">
...
height: 50px;
padding-left: 1%;">
Call +965 12345678 Extended hours M-F 6am-8pm</p>
...
<td>
<table width="730" cellpadding="0" cellspacing="0" bgcolor="#e0dede" border="0" class="centerize" style="mso-table-lspace:0pt;mso-table-rspace:0pt;">
<tbody><tr>
<td valign="middle" align="left" height="60" style="line-height:1px;padding-left:15px; margin: auto; text-align: center; padding-top: 5px; "><a href="#" target="_blank" style="text-align: center;margin: auto;"><img src="<?php echo base_url(); ?>/Babies Moments English/images/logo/logo-2.png" style="display:block; margin: auto;" alt="Logo Image" border="0" align="top" hspace="0" vspace="0" width="252" height="60"></a></td>

</tr>

<tr>
<td valign="top" style="margin: auto; text-align: center; border-collapse:collapse;color:#222;font-family:Geneva,Arial;font-size:14px;line-height:1.5;letter-spacing:normal;text-align:left;padding-right:15px;text-align:left;padding-left:15px">
<h2 class="titile-main" style="text-align: center;">Contact Mail</h2>
<!-- <p style="text-align: center;">Thank you for your Interest</p>
<p style="font-weight: 600;text-align: center;"><strorng>Welcome <?php echo $name ?></strorng></p> -->
<p style="color:#222;font-family:Geneva,Arial;font-weight: 600;text-align: center;">A customer with following details has contacted.</p>
</td>
</tr>
...
<tr>
<td style=" width: 50%; border: 1px solid #dddddd;text-align: center;padding: 12px;" class="total"><strong>Name</strong></td>
<td class="unit" style="width: 50%; border: 1px solid #dddddd;text-align: center;padding: 12px;color:#49b2e6;">
<?php echo $name ?>
</td>
</tr>

<tr>
<td class="total" style="width: 50%; border: 1px solid #dddddd;text-align: center;padding: 12px;"><strong>Phone</strong></td>
<td class="unit" style="width: 50%; border: 1px solid #dddddd;text-align: center;padding: 12px;"><?php echo $phone ?></td>
</tr>

<tr>
<td class="total" style="width: 50%; border: 1px solid #dddddd;text-align: center;padding: 12px;"><strong>Email</strong></td>
<td class="unit" style="width: 50%; border: 1px solid #dddddd;text-align: center;padding: 12px;"><?php echo $email ?></td>
</tr>

<tr>
<td class="total" style="width: 50%; border: 1px solid #dddddd;text-align: center;padding: 12px;"><strong>Subject</strong></td>
<td class="unit" style="width: 50%; border: 1px solid #dddddd;text-align: center;padding: 12px;"><?php echo $subject ?></td>
</tr>

<tr>
<td class="total" style="width: 50%; border: 1px solid #dddddd;text-align: center;padding: 12px;"><strong>Message</strong></td>
<td class="unit" style="width: 50%; border: 1px solid #dddddd;text-align: center;padding: 12px;"><?php echo $message ?></td>
</tr>
...
<td>
	...
	<!--  <div align="center" style="margin: 2%">
 	<a href="<?php echo base_url(); ?>index.php/BabiesController/logincheck_user_mail?username=<?php echo $username ?>&&userpass=<?php echo $password ?>" style="text-decoration: none; background: #3babe2;color: #ffff;padding: 10px 5px;border-radius: 10px;cursor: pointer;margin: 1%">Login to Babies Moments Store</a>
 </div> -->



	<p class="RegularTextTD" style="font-size: 14px; color: #000; text-align: center;">If you have any questions or need any help, don't hesitate to contact our support team!</p></td>
</tr>
...
<table width="100%" align="left" cellpadding="0" cellspacing="0" border="0" class="table518b" style="mso-table-lspace:0pt;mso-table-rspace:0pt; background: #3babe2; padding: 20px; text-align: center;">
<tbody>
<tr>
...
<tr>
<!--SHIPPING ADDRESS AND Payment Method Information-->
<td height="20" class="RegularTextTD" style="font-size: 18px; text-align: center; padding-bottom: 10px;">+965 12345678 . support@Babiesmoments.com</td>
</tr>
...
<!-- <tr style="text-align: center;"><td align="center" style="font-family: sans-serif; padding: 10px 0px;"><a href="<?php echo base_url(); ?>index.php/TootController/myaccount" style="font-size: 13px; color: #000; float: left;" target="_blank">My Account <span style="margin-left: 5px; margin-right: 10px;">|</span> </a>
<a href="<?php echo base_url(); ?>index.php/TootController/myaccount" style="font-size: 13px; color: #000; float: left;" target="_blank">Order History <span  style="margin-left: 5px; margin-right: 10px;">|</span> </a>
<a href="<?php echo base_url(); ?>index.php/Home" style="font-size: 13px; color: #000; float: left;">Weekly Specials <span  style="margin-left: 5px; margin-right: 10px;">|</span></a>
<a href="<?php echo base_url(); ?>index.php/Home" style="font-size: 13px; color: #000; float: left;"> New Arrivals <span  style="margin-left: 5px; margin-right: 10px;">|</span></a>
...
<td height="5" class="mailingOptionsTD"><br>
...
<!-- <td align="center" style="font-family: sans-serif; padding: 10px 0px;"><p><br>
If you would like to unsubscribe, <a href="" style="cursor: pointer;">click here.</a></p></td> -->
</tr>
