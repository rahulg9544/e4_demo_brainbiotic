            ...
            <div class="col-md-4">
              <div class="media">
                <div class="media-body">
                  <div class="display-6">Return Policy</div>
...
<div class="modal fade-scale" id="trackermodal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
     ...
     <script type="text/javascript">
      ...
      function getpromocode(){
           $.ajax({
                method: "POST",
                url: "<?php echo base_url('index.php/Admin_returnpolicy/get_aboutinf');?>/",
                data: '', 
      ...
      // }
        ...
        $.ajax({
              method: "POST",
              url: "<?php echo base_url('index.php/Admin_returnpolicy/editaboutinfo');?>/",
            ...
            //   alert(data);
              ...
              $('#tuid').val(res.returnpolicy_id );
              $('#tucontent').summernote('code',res.returnpolicy_content);
              $('#tucontent_arab').summernote('code',res.returnpolicy_content_ar);
      ...
      $("#idFormpromo").submit(function(e) {
         ...
         $.ajax({
                method: "POST",
                url: "<?php echo base_url('index.php/Admin_returnpolicy/updatetcinfo');?>/",
