    ...
    <nav class="menu-block">
      <ul class="nav">
        <li class="nav-item mainmenu-user-profile">
          ...
          <div class="menu-block-label"><b>
              <!--<?php //echo strtoupper($_SESSION['admindisplay']);
                  ?>--></b><br>
      ...
      <ul class="nav">
        ...
        <li class="nav-item"><a class="nav-link" href="<?php echo base_url(); ?>index.php/Admin_banner"><i class="icon ion-map"></i>
            <div class="menu-block-label">Banner/Slider</div>
          </a></li>
    ...
    <div class="view-wrapper">
      ...
      <div class="topbar-wrapper">
        ...
        <div class="topbar-wrapper-mobile-nav"><a class="topbar-togger js-minibar-toggler" href="#"><i class="icon ion-ios-arrow-back hidden-md-down"></i><i class="icon ion-navicon-round hidden-lg-up"></i></a><a class="topbar-togger pull-xs-right hidden-lg-up js-nav-toggler" href="#"><i class="icon ion-android-person"></i></a>
          ...
          <a class="topbar-wrapper-logo demo-logo" href="<?php echo base_url(); ?>Adminhome">Brainbiotic</a>
        </div>

        <ul class="nav navbar-nav topbar-wrapper-nav">

          <!-- new one start -->
          <!--<li class="nav-item dropdown"><a class="nav-link" href="<?php //echo base_url('index.php/admindelivery');
                                                                      ?>"  aria-haspopup="true" aria-expanded="true" title="ORDERS"><i class="icon ion-android-notifications-none"></i><span class="badge badge-danger status" id="countbadge"></span></a>
</li>-->
          <!-- new one end -->
