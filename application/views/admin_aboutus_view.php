                  ...
                  <div class="row m-b-2">
                    ...
                    <div class="form-group col-sm-12">
                     ...
                     <div class="form-group col-sm-6">
                       <h4 class="demo-sub-title">Banner Image <span style="font-size: 10px">(min-width:1600px, win-height:459px)</span></h4>
                     ...
                     <div class="form-group col-sm-6">
                       <h4 class="demo-sub-title">Content Image <span style="font-size: 10px">(min-width:423px, win-height:478px)</span></h4>
