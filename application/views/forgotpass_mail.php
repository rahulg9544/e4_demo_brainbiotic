...
<style type="text/css">
	...
	.AnnouncementTD				{color:#7f8c9d;font-family:"Trebuchet MS", Arial, Helvetica, sans-serif;font-size:16px;text-align:right;line-height:150%;}
	.AnnouncementTD a				{color:#7f8c9d;}

	.viewOnlineTD					{color:#ffffff;font-family:"Trebuchet MS", Arial, Helvetica, sans-serif;font-size:12px;text-align:left;line-height:22px;}
	.viewOnlineTD a					{color:#ffffff;}

	.menuTD						{color:#ffffff;font-family:"Trebuchet MS", Arial, Helvetica, sans-serif;font-size:12px;text-align:right;line-height:22px;}
	.menuTD a						{color:#ffffff;}	
	
	.buttonTD, .iconTextTD,.td528Button	{color:#ffffff;font-family:"Trebuchet MS", Arial, Helvetica, sans-serif;font-size:15px;font-weight:lighter;text-align:center;line-height:23px;}
	...
	.headerTD						{color:#7f8c9d;font-family:"Trebuchet MS", Arial, Helvetica, sans-serif;font-size:18px;text-align:center;line-height:25px;}
	.headerTD a						{color:#ff675f;}
	.header2TD,.iconHDTD			{color:#cfd6e2;font-family:"Trebuchet MS", Arial, Helvetica, sans-serif;font-size:17px;text-align:center;line-height:25px;}
	.header2TD a,.iconHDTD a		{color:#ff675f; font-weight:bold;}
	.header3TD						{color:#7f8c9d;font-family:"Trebuchet MS", Arial, Helvetica, sans-serif;font-size:17px;text-align:center;line-height:27px;}
	.header3TD a					{color:#ff675f; font-weight:bold;}
	.header4TD						{color:#7f8c9d;font-family:"Trebuchet MS", Arial, Helvetica, sans-serif;font-size:18px;text-align:left;line-height:25px;}
	.header4TD a					{color:#ff675f;}
	.headerPrcTD					{color:#7f8c9d;font-family:"Trebuchet MS", Arial, Helvetica, sans-serif;font-size:40px;text-align:center;}
	...
	.RegularText2TD,	
	.RegularText3TD	,
	.confLinkTD						{color:#7f8c9d;font-family:"Trebuchet MS", Arial, Helvetica, sans-serif; font-size:13px;text-align:left;line-height:23px;}
	.RegularText3TD					{text-align:center; font-size:15px;}
	.RegularTextTD a,
	.RegularText2TD a,
	.RegularText3TD a				{color:#49b2e6; font-weight:normal;}
	.confLinkTD a					{color:#67bffd; font-weight:bold;word-break:break-all;}
	
	.invoiceTD						{color:#7f8c9d;font-family:"Trebuchet MS", Arial, Helvetica, sans-serif; font-size:19px;text-align:center;line-height:23px;}
	.invoiceTD a						{color:#ff675f;}
	.invCap							{color:#7f8c9d;font-family:"Trebuchet MS", Arial, Helvetica, sans-serif;text-align:center;font-size:15px;}
	.invCap a						{color:#7f8c9d;}
	.invReg							{color:#7f8c9d;font-family:"Trebuchet MS", Arial, Helvetica, sans-serif;font-size:13px;text-align:center;}
	.invReg a						{color:#7f8c9d;}
	.invInfoA						{color:#7f8c9d;font-family:"Trebuchet MS", Arial, Helvetica, sans-serif; font-size:12px;text-align:right;line-height:20px;}
	.invInfoA a						{color:#7f8c9d;pointer-events:none;}
	.invInfoB						{color:#7f8c9d;font-family:"Trebuchet MS", Arial, Helvetica, sans-serif; font-size:12px;text-align:left;line-height:20px;}
	.invInfoB a						{color:#7f8c9d;pointer-events:none;}	
	
	td a img							{text-decoration:none;border:none;}
	
	.companyAddressTD				{color:#7f8c9d;font-family:"Trebuchet MS", Arial, Helvetica, sans-serif;font-size:13px;text-align:center;line-height:190%;}
	.companyAddressTD a			{color:#7f8c9d;}
	.companyAddress2TD			{color:#7f8c9d;font-family:"Trebuchet MS", Arial, Helvetica, sans-serif;font-size:13px;text-align:center;line-height:190%;}
	.companyAddress2TD a			{color:#7f8c9d;pointer-events:none;}
	
	.mailingOptionsTD,.termsConTD,.termsCon2TD		{color:#888888; padding-top:15px;font-family:"Trebuchet MS", Arial, Helvetica, sans-serif;font-size:14px;text-align:center;line-height:170%;}
	.mailingOptionsTD a,.termsConTD a,.termsCon2TD a	{color:#888888;font-weight:normal;}
	...
	body{-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;-webkit-font-smoothing:antialiased;margin:0 !important;padding:0 !important;min-width:100% !important;}
     ...
     p{ font-size: 15px; font-family:"Trebuchet MS", Arial, Helvetica, sans-serif; margin-top:5px;} 
...
.invoice footer {
    ...
    .thank-bt{ background: #343399; padding: 10px; width: 80%; margin: 0 auto; border-radius: 10px 10px 10px 10px; text-align: center; font-family:"Trebuchet MS", Arial, Helvetica, sans-serif; color: #fff; display: block; margin-top: 10px;}
...
@media only screen and (max-width: 479px) 
    ...
    .headr{ background: #49b2e6; width:700px;  height: 30px;  font-family:"Trebuchet MS", Arial, Helvetica, sans-serif; padding: 8px 15px;}
    .headr p{  float: left; 13px; float: left; color: #fff;}
    
    .titile-main{ color:#222;display:block;font-family:"Trebuchet MS", Arial, Helvetica, sans-serif;font-size:20px;font-style:normal;font-weight:italic;line-height:22px;letter-spacing:normal;margin:0;margin-bottom:4px; margin-top:10px;text-align:left}
...
<center> 
 ...
 <table width="100%" align="center" cellpadding="0" cellspacing="0" border="0" bgcolor="#ededed" style="table-layout:fixed;margin:0 auto;mso-table-lspace:0pt;mso-table-rspace:0pt; margin-bottom:0px; padding-top: 0px; border-top:4px solid #f39702; ">
				...
				<table width="700" bgcolor="#ededed" align="center" cellpadding="0" cellspacing="0" border="0" class="table600" style="mso-table-lspace:0pt;mso-table-rspace:0pt;">
					...
					<tbody><tr>
						<td width="618" class="tdLogo" bgcolor="#ededed" align="left"> 
                          <div class="headr"> 
                            <p>
Call +965 6665 0677 Extended hours M-F 6am-8pm</p>
                              
                            
                            </div>    
                            
							<table width="730" align="left" cellpadding="0" cellspacing="0" border="0" bgcolor="#e0dede" class="table600Logo" style="mso-table-lspace:0pt;mso-table-rspace:0pt;">
								<tbody><tr>
									...
									<td>
										<table cellpadding="0" cellspacing="0" bgcolor="#e0dede" border="0" class="centerize" style="mso-table-lspace:0pt;mso-table-rspace:0pt;">
											<tbody><tr>
												<td valign="middle" align="left" height="60" style="line-height:1px;padding-left:15px; padding-top:18px;"><a href="#" target="_blank"><img src="http://demo8.chrisansgroup.com/babies_moments/html/images/logo/logo.png" style="display:block;" alt="Logo Image" border="0" align="top" hspace="0" vspace="0" width="176" ></a></td>
...
<h4 class="titile-main">Hello <?php echo $name ?></h4>
<p>We're sorry you're having trouble logging into your <a href="#" style="color:#49b2e6;">babiesmoments.com</a> account. We're happy to be of service, just click on the forget my password link. <a href="<?php echo base_url(); ?>BabiesController/resetpassword?cod=<?php echo $resetcode ?>&&uname=<?php echo $username ?>" style="color:#49b2e6;">reset password</a></p> 
<p style="font-weight: 600"><strorng>This link is only valid for 24 hours.</strorng></p>   
    
<p>If you didn't ask us for help with your password,send an email to <a href="#" style="color:#49b2e6;">info@babiesmoments.com</a> or call us <br>at +965 6665 0677</p>    
</td>
</tr>
...
<table width="730" align="center" cellpadding="0" cellspacing="0" border="0" class="table600" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;"> 
 <tbody> 
 <tr> <td>
 <table width="730" align="left" cellpadding="0" cellspacing="0" border="0" class="table600" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;"> 
<tbody> 
<tr> <td> 
...
<td height="15" class="RegularTextTD" style="font-size: 15px; text-align: center; padding-bottom: 2px;">Your customer loyalty representative</td>
</tr>
     
    <tr>
<!--SHIPPING ADDRESS AND Payment Method Information-->
<td height="15" class="RegularTextTD" style="font-size: 15px; text-align: center; padding-bottom: 2px;">For any questions, please call M-F 6am - 8pm ET</td>
</tr> 
     
     <tr>
<!--SHIPPING ADDRESS AND Payment Method Information-->
<td height="15" class="RegularTextTD" style="font-size: 15px; text-align: center; padding-bottom: 2px;">+965 6665 0677 . <a href="#" style="color:#49b2e6;">info@babiesmoments.com</a></td>
</tr>  
					...
					<tbody><tr>
						<td> 
                                          <table width="510" align="center" cellpadding="0" cellspacing="0" border="0" bgcolor="#ededed" class="table600">         	
                                                ...
                                                <tr><td align="center" style="font-family: Trebuchet MS,Arial,Helvetica,sans-serif; padding: 10px 0px; text-align: center;"><a href="#" style="font-size: 13px; color: #333;" target="_blank">My Account <span style="margin-left: 5px; margin-right: 10px;">|</span> </a> 
    <a href="#" style="font-size: 14px; color: #333; font-family: Trebuchet MS,Arial,Helvetica,sans-serif;" target="_blank">Order History <span  style="margin-left: 5px; margin-right: 10px;">|</span> </a>  
    <a href="#" style="font-size: 14px; color: #333; font-family: Trebuchet MS,Arial,Helvetica,sans-serif;">Offers <span  style="margin-left: 5px; margin-right: 10px;">|</span></a> 
    <a href="#" style="font-size: 14px; color: #333; font-family: Trebuchet MS,Arial,Helvetica,sans-serif;"> New Arrivals <span  style="margin-left: 5px; margin-right: 10px;">|</span></a> 
    </td></tr>    
                                ...
                                This email was sent to<a href="#" style="color:#49b2e6;"> mehroof@chrisansgroup.com.</a><br>
                                You're receiving this email because you opted in at <a href="#" style="color:#49b2e6;">babiesmoments.com</a><br>
© 2020 Babies Moments , All rights reserved.                    
...
<table width="100%" style="background: #ccc; padding: 10px;">
    ...
    <td align="center" style="font-family:Trebuchet MS, Arial, Helvetica, sans-serif; padding: 10px 0px;"><p>You received this email from Aquamarine Exotic..<br>
If you would like to unsubscribe,<a href="" style="color:#49b2e6;">click here.</a></p></td>
    </tr>
