        ...
        <table class="table table-hover table-bordered  " id="tablefillcat">
           <thead>
                  ...
                  <tbody>
                     ...
                     <td>
                            <a target="blank" href="<?php echo base_url();?>/uploads/<?php echo $row->about_banner_image ?>"><img height="60" width="120" src="<?php echo base_url(); ?>uploads/<?php echo $row->about_banner_image ?>"></a>
                          </td>
